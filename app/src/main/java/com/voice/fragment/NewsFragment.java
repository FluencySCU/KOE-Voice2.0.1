...
import com.voice.R;
import com.voice.activity.WebActivity;
	...
	private void init() {
		...
		mSearchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
			...
			public boolean onQueryTextSubmit(String s) {
				...
				intent.putExtra("url","https://cn.bing.com/search?q="+s);//传输URL给WEB页面
				intent.setClass(NewsFragment.this.mContext, WebActivity.class);
